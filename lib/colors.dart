...
const sa_blue = Color(0xff245C9C);
...
const idealFitPressedColor = Color(0xff45CBCB);
const otherFitColor = Color(0xffE5EBF0);
const otherFitPressedColor = Color(0xffFFCC33);
